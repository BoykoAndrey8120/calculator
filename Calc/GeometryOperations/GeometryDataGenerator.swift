...
class GeometryDataGenerator {
    ...
    func createData() -> [Figure] {
        ...
        let rectAreaFormula = Formula(name: "RectSquareFormula", fields: rectAreaFields, formula: "a*b")
        let rectPerimeterFields = [FieldInfo(name: "a", value: 3), FieldInfo(name: "b", value: 4)]
        let rectPerimeterFormula = Formula(name: "RectSquareFormula", fields: rectPerimeterFields, formula: "(a+b) * 2")
        ...
        let squareAreaFormula = Formula(name: "squareAreaFormula", fields: squareAreaFields, formula: "a**2")
        let squarePerimeterFields = [FieldInfo(name: "a", value: 3)]
        let squarePerimeterFormula = Formula(name: "squarePerimeterFormula", fields: squarePerimeterFields, formula: "a * 4")
        ...
        let circleAreaFormula = Formula(name: "circleAreaFormula", fields: circleAreaFields, formula: "pi*r**2")
        let circleLenghtFields = [FieldInfo(name: "r", value: 3), FieldInfo(name: "pi", value: 3.14)]
        let circleLenghtFormula = Formula(name: "circleLenghtFormula", fields: circleLenghtFields, formula: "2*pi*r")
        ...
        let equilateralTriangleAreaFieldsFormula = Formula(name: "equilateralTriangleArea", fields: equilateralTriangleAreaFields, formula: "(sqrt/4)*a**2")
//        let circleLenghtFields = [FieldInfo(name: "r", value: 3), FieldInfo(name: "pi", value: 3.14)]
